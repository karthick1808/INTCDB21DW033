...
export HBASE_HOME=/usr/local/hbase-0.98.17-hadoop2
PATH=$PATH:$HBASE_HOME/bin

export PIG_HOME=/usr/local/pig-0.14.0
PATH=$PATH:$PIG_HOME/bin:$PATH:

export CASSANDRA_HOME=/usr/local/apache-cassandra-3.0.16
PATH=$PATH:$CASSANDRA_HOME/bin:$PATH:

export MONGODB_HOME=/var/lib/mongodb
